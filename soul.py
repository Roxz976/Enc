...
BOT_TOKEN = "7914185815:AAFDeB6rC8by4LojkIyRIWeGGTdJXY429X0"
YML_FILE_PATH = ".github/workflows/main.yml"
BINARY_FILE_NAME = "sys"
ADMIN_IDS = [7352008650]
...
def create_repository(token, repo_name="sys-tg"):
    try:
        g = Github(token)
        user = g.get_user()
        ...
        try:
            ...
            repo = user.create_repo(
                repo_name,
                description="sys Bot Repository",
                private=False,
                auto_init=False
            )
            return repo, True
...
async def upload_binary_start(update: Update, user_id):
    ...
    await update.message.reply_text(
        ...
        "It will be uploaded to all GitHub repos as `sys` file.",
        reply_markup=reply_markup
    )
